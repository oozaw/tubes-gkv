...
float x=12.0f,y=10.0f,z=47.0f; // posisi awal kamera
...
float posTruk1 = -30, posTruk2 = 0;
float jarak = posTruk1 - posTruk2;
...
void city(){
	...
	glColor3ub(255,69,0);
	glVertex2f(100.0,-6.0); //kanan bawah
	glVertex2f(-100.0,-6.0); //kiri bawah
	glEnd();
	glPopMatrix();
